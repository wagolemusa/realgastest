...
const FullsetGas = () => {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          const response = await axios.get(`${process.env.ENVIRONMENT_URL}/api/products/fullset12`);
      ...
      <Suspense>
        <div className="gasscooker">
          ...
          <div className='rightbtn'>
              <a href='/' className='title-border'>Full-Set 12kgs</a>
